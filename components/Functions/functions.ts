...
export const getData = async (
  ...
  fetch("/api/typing/10")
    ...
    .then(data => {
      ...
      data.quote = "Jack quickly vexed the lazy dog by jumping over five bright, curious foxes while he was puzzled by a quirky maze. Each twist and turn led to a new adventure, showcasing vivid colors and dazzling patterns. In this whimsical world, every fox danced gracefully, while zany squirrels scurried about, adding to the excitement and fun";
