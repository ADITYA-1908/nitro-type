  ...
  return (
      <div className={` ${props.className} bg-AAprimary flex flex-col justify-center items-center py-8 space-y-4 `}>
        ...
        <div className="flex flex-row space-x-8">
          <ClickableIcon
            href={"https://github.com/ADITYA-1908/"}
            Icon={GithubIcon}
          />
          <ClickableIcon
            href={"https://www.linkedin.com/in/aditya-basantia-a45b20227"}
            Icon={LinkedinIcon}
          />
          <ClickableIcon
            href={"https://www.instagram.com/adi_subham?igsh=ZWFtdno4eXIzd3hi"}
            Icon={InstagramIcon}
          />
          {/* <ClickableIcon
    ...
    text-sm  space-y-2  "
          >
            <span className="group-hover:text-AAsecondary sm:text-sm text-xs">
              Designed & Built by Aditya Basantia
            </span>
