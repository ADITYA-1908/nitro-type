...
import { calculateAccuracy, calculateWpm, getData, handleOnChangeInput } from "../components/Functions/functions";
    ...
    >
      {!isFinished && !(myText[1].length == 0) && (
        <>
          ...
          <Footer className="absolute bottom-0" link="https://github.com/ADITYA-1908/" />
        </>
      )}
      ...
      {isFinished && (
        <>
          ...
          />
          <Footer className="pt-16" link="https://github.com/ADITYA-1908/" />
        </>
      )}
    </div>
  );
